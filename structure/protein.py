...
if os.name == 'nt':
    ...
    sys.path.append('/work/cascades/kelsieking23/scripts/python')
    from structure.ligand import Ligand
    from utilities.rewritepdb import addChainID
    from utilities.rewritepdb import writePDB
    from utilities.rewritepdb import editChainIDResidue
    # from mdanalysis.multixpm import MultiXPM   

class Protein:

    def __init__(self, structure, residues=None, ignore=None, covalent_ids=None, ligands=None):
        '''
